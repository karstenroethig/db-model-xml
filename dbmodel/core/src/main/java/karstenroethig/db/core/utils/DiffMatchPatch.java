...
public class DiffMatchPatch {
     ...
     * @param   text1       Old string to be diffed.
     * @param   text2       New string to be diffed.
     * @param   checklines  Speedup flag. If false, then don't run a line-level diff first to identify the changed
     ...
     * @param   checklines  Speedup flag. If false, then don't run a line-level diff first to identify the changed
     *                      areas. If true, then run a faster slightly less optimal diff.
     * @param   deadline    Time when the diff should be complete by. Used internally for recursive calls. Users should
     ...
     * word boundary. e.g: The c<ins>at c</ins>
     *
     * <p>ame. -> The <ins>cat</ins></p>
     *
     * <p>came.</p>
     *
     * @param  diffs  LinkedList of Diff objects.
    ...
    protected static class LinesToCharsResult {
        ...
        /**
         * Creates a new LinesToCharsResult object.
         *
         * @param  chars1     DOCUMENT ME!
         * @param  chars2     DOCUMENT ME!
